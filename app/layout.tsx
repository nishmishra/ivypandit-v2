...
const pageMeta: Record<string, { title: string; description: string }> = {
  ...
  '/research/consciousness/avadhana': { title: 'Avadhāna: Indian Science of Attention & Memory | IvyPandit', description: 'The definitive evidence-aware guide to Avadhāna, Avadhanam, attention, working memory, cognitive expertise, neuroplasticity, and a rigorous neuroscience research agenda.' },
