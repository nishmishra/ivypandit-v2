    ...
    <html lang="en">
      <body>
        ...
        <header className="header">
          <Link href="/" className="brand"><span className="tree">☀</span><span><b>IVY PANDIT</b><small>Tradition • Curiosity • Science</small></span></Link>
          <nav aria-label="Primary navigation">{nav.map(([name, href]) => <Link key={href} href={href}>{name}</Link>)}</nav>
        </header>
        {children}
